...
namespace Sales.WEB.Repositories
{
    public class Repository : IRepository
    {
        ...
        public async Task<HttpResponseWrapper<object>> Put<T>(string url, T model)
        {
            ...
            var responseHttps = await _httpClient.PutAsync(url, messageContent);
            return new HttpResponseWrapper<object>(null, !responseHttps.IsSuccessStatusCode, responseHttps);
        }
